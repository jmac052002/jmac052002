...
**Cloud**
AWS Lambda · S3 · EC2 · RDS · VPC · IAM · Route 53 · CloudFront · API Gateway · SNS · SQS · Auto Scaling · Aurora Serverless · Secrets Manager · Kinesis · Firehose · Glue · Athena · SageMaker · CloudWatch · X-Ray · CloudTrail

**AI / ML & Agent Systems**
Anthropic SDK · Claude Code · FastMCP / MCP Protocol · Amazon Bedrock · SageMaker · Amazon Rekognition · Hermes (Nous Research) · Ollama (local LLMs) · RAG Pipelines · Tool Calling · Agent Loop Architecture

**Infrastructure as Code**
Terraform · AWS CloudFormation · AWS SAM · Ansible

**Containers & Orchestration**
Docker · Kubernetes · K3s · Helm · k9s · FastAPI

**Languages**
Python (Boto3 · FastAPI · Typer · Strawberry GraphQL) · Bash · HCL · Go (learning)

**DevOps & Observability**
GitHub Actions · Git · AWS CLI · Linux (Ubuntu / WSL2) · Nginx · Gunicorn · tmux
